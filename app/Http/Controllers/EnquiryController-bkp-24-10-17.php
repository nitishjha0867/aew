    ...
    public function generateQuotation(Request $request){
    	...
    	$enq_check = DB::table('enquiry')->select('quotation_no', 'quotation_file_name', 'quotation_revisions')->where('enquiry_no', $enq_num);
			...
			if($enq_exists){
		    	...
		    	$quotation_html = "<html><head><style>
				    ...
				    table.borderless_table td, td.has_table_child>table{border: none; /*font-size: 10px;*/}
				    ...
				    tr.tr_company_info>.aew_logo_wrapper{position: relative; height: 100px;}
				    tr.tr_company_info>.aew_logo_wrapper>h3{font-size: 3em; margin: 0; font-family: serif; line-height:0.5;}
				    tr.tr_company_info>.aew_logo_wrapper>h6{line-height: 0;}
		   		...
		   		$quotation_html.= "<div id='quotation_master_wrapper'>
		   		<div class='table_border_helper'>
			      <table id='quotation_header'>
			      ...
			      <table id='quotation_table''>
			        <tr class='thead'>
			          ...
			          <th style='width:300px' class='border_left'>Description</th>
			        ...
			        $p_c = 1; $total = $posted_data['total_order_value'];
			        ...
			        foreach($products_arr as $product_id){
			        	...
			        	$quotation_html.= "<tr class='tbody'>
			                <td style='width:15px; height: 30px;' class='text-center'>$p_c</td>
			                <td style='width:300px; height: 30px;' class='border_left'>$p_n</td>
			                <td style='width:30px; height: 30px;' class='border_left text-center'>".IntHelper::intoCurrencyFormat($p_q)."</td>
			                <td style='width:70px; height: 30px;' class='border_left text-right'>$p_r_d</td>
			                <td style='width:30px; height: 30px;' class='border_left text-center'>$p_u_d</td>
			                <td style='width:70px; height: 30px;' class='border_left text-right'>$p_a</td>
			            </tr>";
			        ...
			        if($products_note!==""){
				        ...
				        $quotation_html.= "<tr class='tbody' style='500px'>

			                <td style='width:15px; height: 30px;' class='text-center'></td>

			                <td style='width:300px; height: 30px;' class='border_left'><span style='color:red'><u>Note:</u> ".$products_note."</span></td>

			                <td style='width:30px; height: 30px;' class='border_left text-center'></td>

			                <td style='width:70px; height: 30px;' class='border_left text-right'></td>
			      ...
			      <div id='quotation_footer'>
			        ...
			        <div id='auth_sign_wrapper'>
			          <p>For Ashok Engineering Works</p>
			          <img src='$aew_sign' id='aew_sign'>

	      	...
	      	<div class="col-md-10 col-md-offset-1">
				...
				{{ csrf_field() }}
					...
					<div class="col-md-10 form-group form-group1 col-md-offset-1 client_drawing_div1">
						<label class="col-md-4 label-control">Client Drawing <span class="client_drawing_count">1</span></label>
						<div class="col-md-8">
							<input type="file" name="client_drawing_1" class="drawing_file" required>
					...
					<div class="product_details1">
						<div class="col-md-10 form-group form-group1 col-md-offset-1">
							...
							<div class="col-md-4">
								<input class="item_code" type="text" name="item_code1" value="" placeholder="Item Code" title="Item Code">
							</div>
							<div class="col-md-4">
								<input class="product_name" type="text" name="product_name1" value="" placeholder="Product Name" title="Product Name">
							</div>
						</div>
						<div class="col-md-10 form-group form-group1 col-md-offset-1">
							...
							<div class="col-md-2">
								<input class="product_quantity" type="text" name="product_quantity1" value="" placeholder="Quantity" title="Product Quantity">
							</div>
						
							<div class="col-md-2">
								<select class="product_unit" name="product_unit1" title="Unit">
							...
							<div class="col-md-4 prod_draw_tr">
								<select class="product_drawing" name="product_drawing1[]" title="Select drawing number for this product" multiple>
								</select>
							</div>
							{{-- <div class="col-md-4">
...
@endsection
  ...
  $('#add_client_drawing').click(function(){
	  ...
	  div_cloned.find('.drawing_file').attr("name", "client_drawing_"+temp_count);
	  div_cloned.find('.drawing_numbers').attr("name", "client_drawing_number_"+temp_count);
	  div_cloned.find('.client_drawing_count').text(temp_count);
  ...
  $('#add_product').click(function(){
	  ...
	  div_cloned.find('.item_code').attr("name", "item_code"+temp_count);
	  div_cloned.find('.product_name').attr("name", "product_name"+temp_count);
	  div_cloned.find('.product_quantity').attr("name", "product_quantity"+temp_count);
	  div_cloned.find('.product_unit').attr("name", "product_unit"+temp_count);
	  var curr_dr_opts = div_cloned.find('.product_drawing2').html();
	  div_cloned.find('.product_drawing').remove();
	 	div_cloned.find('.prod_draw_tr').html(`<select class="product_drawing" name="product_drawing${temp_count}[]" title="Select drawing number for this product" multiple>${curr_dr_opts}</select>`);

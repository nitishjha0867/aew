        ...
        <div class="panel-body">
          ...
          {{ csrf_field() }}
            ...
            <div class="form-group">
              ...
              <div class="col-md-4 form-group1">
                <input id="enter_taxes" type="text" name="taxes" class="form-control" placeholder="Tax Rate and Details" title="Enter tax rate and additional details, if any" autocomplete="off" required="">
              </div>
              <div class="clearfix"> </div>
            </div>
            <div class="form-group">
